                    ...
                    <div className="table-responsive">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <div>
                                    <img src={require("../Assets/img/small-logos/logo-xd.svg")} className="avatar avatar-sm me-3" alt="xd" />
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={require("../Assets/img/small-logos/logo-atlassian.svg")} className="avatar avatar-sm me-3" alt="atlassian" />
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={require("../Assets/img/small-logos/logo-slack.svg")} className="avatar avatar-sm me-3" alt="team7" />
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={require("../Assets/img/small-logos/logo-spotify.svg")} className="avatar avatar-sm me-3" alt="spotify" />
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={require("../Assets/img/small-logos/logo-jira.svg")} className="avatar avatar-sm me-3" alt="jira" />
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={require("../Assets/img/small-logos/logo-invision.svg")} className="avatar avatar-sm me-3" alt="invision" />
                                </div>
                                <div className="d-flex flex-column justify-content-center">
